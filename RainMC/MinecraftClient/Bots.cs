    ...
    namespace Bots
    {
        ...
        public class TestBot : ChatBot
        {
            public override void GetText(string text)
            {
                ...
                {
                    ConsoleIO.Write("Bot: " + username + " told me : " + message);
                }
                else if (isChatMessage(text, ref message, ref username))
                {
                    ConsoleIO.Write("Bot: " + username + " said : " + message);
                }
            }
        }
                ...
                foreach (string alert in dictionary)
                {
                    if (comp.Contains(alert))
                    {
                        ...
                        if (ok)
                        {
                            ...
                            //{
                            //    ConsoleIO.WriteLine(comp.Replace(alert, "§c" + alert + "§r"));
                            //}
                            //else
                            {
