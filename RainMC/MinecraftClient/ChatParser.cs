    ...
    static class ChatParser
    {
        ...
        private static void InitRules()
        {
            ...
            if (System.IO.File.Exists(Settings.TranslationsFile))
            {
                ...
                ConsoleIO.Write("Translations file loaded.");
            }
            else //No external dictionnary found.
            {
                ConsoleIO.Write("Translations file not found: \"" + Settings.TranslationsFile + "\"");
                ConsoleIO.Write("You can pick a translation file from .minecraft\\assets\\lang\\");
                ConsoleIO.Write("Some messages won't be properly printed without this file.");
            }
        }
